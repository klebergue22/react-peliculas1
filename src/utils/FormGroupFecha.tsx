...
function toLocaleDateString(arg0: string): string | number | readonly string[] | undefined {
    throw new Error('Function not implemented.');
} 


function toLocaleString(arg0: string): string | number | readonly string[] | undefined {
    throw new Error('Function not implemented.');
}
